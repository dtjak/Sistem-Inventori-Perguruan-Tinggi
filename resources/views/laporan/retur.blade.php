@extends('layouts.app')
@section('title', 'Laporan Retur Barang')
@section('breadcrumb')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">Laporan Retur Barang</h4>
        <p class="text-muted mb-0">Rekapitulasi pengembalian barang inventori yang rusak/cacat ke supplier</p>
    </div>
    <div>
...
<div class="card data-card mb-4">
    <div class="card-header bg-white py-3">
        <form action="{{ route('laporan.retur') }}" method="GET" class="row g-2 align-items-center">
            <div class="col-md-3">
            ...
            <tbody>
                @forelse($data as $index => $item)
                    <tr>
                        ...
                        <td><span class="badge bg-light text-dark font-monospace">{{ $item->nomor_retur }}</span></td>
