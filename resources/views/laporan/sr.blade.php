@extends('layouts.app')
@section('title', 'Laporan Store Requisition')
@section('breadcrumb')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">Laporan Store Requisition (SR)</h4>
        <p class="text-muted mb-0">Rekap pengajuan Store Requisition dari berbagai unit kerja</p>
    </div>
...
<div class="card data-card mb-4">
    <div class="card-header bg-white py-3">
        <form action="{{ route('laporan.sr') }}" method="GET" class="row g-2 align-items-center">
            <div class="col-md-3">
            ...
            <tbody>
                @forelse($data as $index => $item)
                    <tr>
                        ...
                        <td><span class="badge bg-light text-dark font-monospace">{{ $item->nomor_sr }}</span></td>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            Tidak ada data pengajuan Store Requisition.
                        </td>
                    </tr>
                @endforelse
            </tbody>
