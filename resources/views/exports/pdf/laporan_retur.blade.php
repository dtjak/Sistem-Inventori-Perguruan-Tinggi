...
<body>
    ...
    <div class="header">
        <h2>Laporan Rekapitulasi Retur Barang</h2>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th style="width: 22%">Supplier Penerima</th>
                <th style="width: 18%">Petugas Gudang</th>
        ...
        <tbody>
            @foreach($data as $index => $item)
                <tr>
                    ...
                    <td class="font-monospace fw-bold">{{ $item->nomor_retur }}</td>
