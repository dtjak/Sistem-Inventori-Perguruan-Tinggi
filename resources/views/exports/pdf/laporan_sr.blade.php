...
<head>
    <meta charset="UTF-8">
    <title>Laporan Store Requisition</title>
    <style>
...
<body>
    ...
    <div class="header">
        <h2>Laporan Rekapitulasi Store Requisition (SR)</h2>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th style="width: 20%">Unit Pemohon</th>
        ...
        <tbody>
            @foreach($data as $index => $item)
                <tr>
                    ...
                    <td class="font-monospace fw-bold">{{ $item->nomor_sr }}</td>
