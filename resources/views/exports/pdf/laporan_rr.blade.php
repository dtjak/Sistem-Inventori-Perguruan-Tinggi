...
<head>
    <meta charset="UTF-8">
    <title>Laporan Receiving Report</title>
    <style>
...
<body>
    ...
    <div class="header">
        <h2>Laporan Rekapitulasi Penerimaan Barang (RR)</h2>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th style="width: 18%">Petugas Penerima</th>
        ...
        <tbody>
            @foreach($data as $index => $item)
                <tr>
                    ...
                    <td class="font-monospace fw-bold">{{ $item->nomor_rr }}</td>
                    <td class="font-monospace">{{ $item->purchaseOrder->nomor_po ?? '-' }}</td>
